<?php
const REGISTER_PARTNER_API_ACTION = 'https://staff.newpas-stg.cf/api/partner_application';
?>
<!DOCTYPE html>
<html lang="ja">
<head>
            ...
            <div class="col-xl-8">
                <div role="form" lang="ja" dir="ltr">
                    ...
                    <form action="<?php echo REGISTER_PARTNER_API_ACTION; ?>" id="register-partner" method="post"
                        ...
                        <div class="row mb-2 form-group">
                            <p class="col-12 fs-14">履歴書・職歴書等<span class="c-ffd70a">＊</span><span style="font-size: 11px;">（pdf, xls, xlsx, doc, docx データ貼付可能) ( 最大1MBまで添付できます)</span></p>
